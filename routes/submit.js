...
export default router.use("/" ,  async function (req, res , next) {
    const  { phonenumber , fullname , email , addressOne , addressTwo , city , state , zipcode } = req.body;
    ...
    try{
        ...
        let response = client.collection('applicants').insertOne( { phonenumber , email , fullname , addressOne , addressTwo , city , state , zipcode , document_uri: [], ssn: ''});
